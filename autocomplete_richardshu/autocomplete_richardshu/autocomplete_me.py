...
autocomplete_richardshu/
    autocomplete_richardshu/
        __init__.py
    setup.py

setup(name='autocomplete_richardshu',
      version='0.1',
      description='An autocomplete program',
      url='https://36-750.github.io/assignments-shshu526',
      author='Richard Shu',
      author_email='richardshuv@icloud.com',
      license='',
      packages=['autocompleters'],
      zip_safe=False)
